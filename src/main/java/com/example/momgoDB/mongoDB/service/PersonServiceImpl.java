...
public class PersonServiceImpl implements PersonService{
    ...
    public List<Document> getPopulationByCity() {
        ...
        GroupOperation groupOperation = Aggregation.group("addresses.city").count().as("POPULATION_COUNT");
        SortOperation sortOperation = Aggregation.sort(Sort.Direction.DESC , "POPULATION_COUNT");

        //PROJECTION IS USED TO TELL I DONT WANT ALL FIELDS , BUT SOMETHING IN PARTICULAR..
        ProjectionOperation projectionOperation = Aggregation.project().andExpression("_id").as("city").andExpression("POPULATION_COUNT").as("count")
                .andExclude("_id"); //exclude the uniqueID generated by mongoDB.
